...
import { errorType, InputField } from "@/app/_types/_website/Global";
...
export default function DynamicForm({
  ...
  const handleDeleteImage = (
    targetImage:
      | File
      | { id?: number; image?: string; tempId?: string }
      | string
  ) => {
    setForm((prev: any) => {
      ...
      const newDeletedImages =
        typeof targetImage === "object" && "id" in targetImage
          ? [...deletedImages, targetImage.image]
          : deletedImages;
    ...
    <>
      ...
      >
        <div className="text-center mb-6">
          ...
          <div className="mt-3 w-24 h-1 mx-auto bg-linear-to-r from-primary via-blue-500 to-primary rounded-full animate-pulse" />
        </div>
      ...
      <MapSelector
        locale="ar"
        setLocation={setLocation as any}
        initialLocation={location as any}
        showMap={showMap}
