  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-gray-200">
        <h2 className="text-xl font-bold text-gray-900 mb-2">تصفية {title}</h2>
        <p className="text-sm text-gray-600">استخدم الفلاتر للبحث في {title}</p>
      </div>
                  ...
                  <div className="space-y-2">
                    {statusOptions.map((status) => (
                      <motion.label
                        ...
                        className="flex items-center rounded-full gap-3 p-2  hover:bg-gray-50 cursor-pointer transition-colors"
                      >
                        <input
                          type="checkbox"
                        ...
                        />
                        <FaSquare className={`text-xs ${status.color}`} />
