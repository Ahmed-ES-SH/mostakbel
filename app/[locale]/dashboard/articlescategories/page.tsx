...
export default function ArticlesCategoriesDashboardPage() {
  const headers = [
    "id",
    "صورة القسم",
    "العنوان (EN)",
  ...
  return (
    <DynamicTable<CategoryType>
      itemDirect="articlescategories"
      headers={headers}
      keys={keys}
      api="/articles-categories"
      searchApi="/articles-categories/search"
      deletedApi="/delete-articles-category"
    />
  );
}
